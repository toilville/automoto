    ...
    >
{
   ...
   */
  pub(raw: __CHANNEL_NAME__Inbound): AgentRequest {
   ...
   */
  sub(response: AgentResponse): __CHANNEL_NAME__Outbound {
   ...
   */
  stream(event: StreamEvent): __CHANNEL_NAME__StreamChunk | null {
