...
- `requestId`, `message`, `cards: Card[]`, `references: Reference[]`
- `toolCalls: ToolResult[]`, `usage?`, `suggestedActions?`
- `finishReason`: `"stop" | "length" | "content_filter" | "tool_calls" | "error"`

**StreamEvent** (streaming): discriminated union on `type`:
...
|---------|----------|-----------|-------------|
| `WebAdapter` | web, home, agents-sdk, teams | ✅ SSE | Conversation history, page scope, SSE chunks |
