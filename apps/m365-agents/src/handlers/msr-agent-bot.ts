/**
 * MSR Agent Bot — M365 Agents SDK ActivityHandler.
 *
...
export class MSRAgentBot extends ActivityHandler {
  ...
  constructor() {
    ...
    this.onMessage(async (context: TurnContext, next) => {
      ...
      try {
        ...
        console.error("[MSRAgentBot] Error processing message:", error);
        await context.sendActivity(
