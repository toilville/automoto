...
export function getConnectionConfig() {
  return {
    id: process.env.CONNECTION_ID ?? "msrResearchContent",
    name: process.env.CONNECTION_NAME ?? "Microsoft Research Content",
    description:
      process.env.CONNECTION_DESCRIPTION ??
      "Research publications, researchers, projects, and news from Microsoft Research",
  };
}
